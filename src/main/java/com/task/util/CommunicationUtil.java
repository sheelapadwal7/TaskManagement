 ...
 * 
 * 
 * @Component public class CommunicationUtil {
 * 
 * 
 ...
 * helper.setSubject("TMS - " + subject); mailSender.send(mimeMessage);
 * 
 * 
 * System.out.println("Sent email for " + subject + " to " + toEmail); return
 * true;
 * 
 * } catch(Exception ex) {
 * 
 ...
 * try {
 * 
 * // String url = "https://api.brevo.com/v3/transactionalSMS/sms"; // String
 * apiKey =
 * "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";
 * String body = "{\"sender\": \"MyShop\", \"recipient\": \"+91"+ mobile
 * +"\", \"content\": \""+ content +"\", \"type\": \"transactional\"}";
 * 
 * 
 ...
 * String.class); String s = response.getBody();
 * 
 * System.out.println("Send sms for " + mobile + " " + s); } catch(Exception ex)
