...
//        .authorizeRequests().
//        requestMatchers("/test").authenticated().requestMatchers("auth/student/login").permitAll()
//        .anyRequest()
//        .authenticated()
//        .and()
...
//		return http.build();
    	...
    	return http.csrf(csrf -> csrf.disable())
                .authorizeHttpRequests(auth -> auth.requestMatchers("/auth/student/login").permitAll())
